...
def load_finetuned_model():
    ...
    print("-------------------------------------")
    model = PeftModel.from_pretrained(model, "/tmpdir/naim/finetuning/model/results_2_epoch_dummy_41rounded/checkpoint-6560", device_map=device_map)
    ...
    with open("/tmpdir/naim/finetuning/data/output/outputs_AND_rerun3_1_150.json", "w") as f:

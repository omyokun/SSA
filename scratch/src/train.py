...
def train(model, args):
    ...
    #print("args training data",args.training.data)
    #print("**args.training.data_kwargs",**args.training.data_kwargs)
    data_sampler = get_data_sampler(args.training.data, n_dims=n_dims,**args.training.data_kwargs)
    print("args",args.training.data_kwargs)
